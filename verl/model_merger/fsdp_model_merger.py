...
if __name__ == "__main__":
    ...
    config = ModelMergerConfig(
            operation="merge",
            backend="fsdp",
            local_dir="/scratch/USERNAME/my-simpleRL/checkpoints/llama_3b_remove_gradsim_Llama-3.2-3B_max_response5120_batch1024_rollout8_klcoef0.0001_entcoef0.001_lr5e-7_logprobbatch128_simplelr_abel_gsm8k_level1_llama-3b_threshold_0.08_N_6762/global_step_80/actor",
            target_dir="/scratch/USERNAME/my-simpleRL/checkpoints/llama_3b_remove_gradsim_Llama-3.2-3B_max_response5120_batch1024_rollout8_klcoef0.0001_entcoef0.001_lr5e-7_logprobbatch128_simplelr_abel_gsm8k_level1_llama-3b_threshold_0.08_N_6762/global_step_80/actor/huggingface",
            hf_model_config_path="/scratch/USERNAME/models/Llama-3.2-3B"
        )
    merger = FSDPModelMerger(config)
    merger.merge_and_save()