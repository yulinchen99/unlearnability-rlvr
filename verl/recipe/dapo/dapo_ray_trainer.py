...
from verl.trainer.ppo.ray_trainer import AdvantageEstimator, RayPPOTrainer, _timer, apply_kl_penalty, compute_advantage, compute_response_mask, reduce_metrics
                ...
                with _timer("step", timing_raw):
                    ...
                    with _timer("reward", timing_raw):
                        ...
                        if reward_extra_infos_dict:
                            new_batch.non_tensor_batch.update({k: np.array(v, dtype=object) for k, v in reward_extra_infos_dict.items()})
                    ...
                    if not self.config.algorithm.filter_groups.enable:
                        ...
                        # TODO: AssertionError: data in the non_tensor_batch must be a numpy.array with dtype=object
                        # File "/scratch/USERNAME/my-simpleRL/verl/protocol.py", line 384, in check_consistency
